...
const local2 = new Array(4).fill(0).map((_, i) => i + 1);
const incoming2 = new Array(7).fill(0).map((_, i) => i + 1);
console.log({ local2, incoming2 });

const validate = incoming2.slice(local2.length - 1);
