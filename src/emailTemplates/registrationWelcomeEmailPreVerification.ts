                                       ...
                                       <td align="center"
                                          ...
                                          <span class="es-button-border"
                                             style="border-style:solid;border-color:#4f46e5;background-color:#4f46e5;border-width:1px;display:inline-block;border-radius:28px;width:auto"><a
                                               href="${ROOT_NODE_ADDRESS}/verify-email/${token}" class="es-button" target="_blank"
                                    ...
                                    <tr style="border-collapse:collapse">
                                       <td align="center"
                                          ...
                                          <p
                                             ...
                                             <a target="_blank" href="${ROOT_NODE_ADDRESS}/verify-email/${token}" style="color: #4f46e5;">${ROOT_NODE_ADDRESS}/verify-email/${token}</a>
                                          </p>
                                       </td>
                                    </tr>
