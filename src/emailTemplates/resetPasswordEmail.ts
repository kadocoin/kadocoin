                                       ...
                                       <td align="center"
                                          ...
                                          <span class="es-button-border"
                                             style="border-style:solid;border-color:#4f46e5;background-color:#4f46e5;border-width:1px;display:inline-block;border-radius:28px;width:auto"><a
                                               href="${ROOT_NODE_ADDRESS}/forget-password/${
    token._id
                                    ...
                                    <tr style="border-collapse:collapse">
                                       <td align="center"
                                          ...
                                          <p
                                             ...
                                             <a target="_blank" href="${ROOT_NODE_ADDRESS}/forget-password/${
    token._id
  }" style="color: #4f46e5;">${ROOT_NODE_ADDRESS}/forget-password/${token._id}</a>
                                          </p>
                                       </td>
                                    </tr>
