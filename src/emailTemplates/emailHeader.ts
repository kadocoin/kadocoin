export default function emailHeader(): string {
  return `<!DOCTYPE html
                           ...
                           <tr style="border-collapse:collapse">
                              <td valign="top" align="center" style="padding:0;Margin:0;width:600px">
                                 <table width="100%" cellspacing="0" cellpadding="0" role="presentation"
                                    ...
                                    <tr style="border-collapse:collapse">
                                       <td align="center"
                                          style="padding:0;Margin:0;padding-top:40px;padding-bottom:40px;font-size:0"><a
                                             href="https://dankoresoft.com" target="_blank"
                                             style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;color:#B7BDC9;font-size:20px"><img
                                                ...
                                                alt="Logo" title="Logo" width="70"></a></td>
                                    </tr>
                                    <tr style="border-collapse:collapse">
                                       <td align="center" style="padding:0;Margin:0;padding-top:10px;font-size:0"><a
                                             target="_blank" href="https://dankoresoft.com"
                                             style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;color:#B7BDC9;font-size:20px"><img
                                                class="adapt-img"
                                                src="https://lfcfwn.stripocdn.email/content/guids/CABINET_729b6a94015d410538fa6f6810b21b85/images/17611519723274581.png"
                                                alt="Kadocoin"
                                                style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;border-radius:3px 3px 0px 0px"
                                                title="Kadocoin" width="600"></a></td>
                                    </tr>
                                 </table>
                              </td>
                           </tr>
